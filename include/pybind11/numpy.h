...
private:
    using ArgsTuple = std::tuple<typename vectorize_arg<Args>::type...>;
...
private:
    ...
    template <size_t Index> using param_n_t = typename std::tuple_element<Index,
             std::tuple<typename vectorize_arg<Args>::call_type...>>::type;
