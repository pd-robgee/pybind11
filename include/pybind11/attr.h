...
struct function_record {
    ...
    /// type indexes of regular (non-args/kwargs) arguments, or void_type for unknown argument
    /// types.  Only non-void_type arguments are eligible for implicit C++ type conversion.
