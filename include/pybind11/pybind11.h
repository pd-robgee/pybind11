...
class class_ : public detail::generic_type {
    ...
    static_assert(!detail::any_of_t<is_invalid_base, options...>::value,
            "Invalid class_ base<...> option: given base type is not a base class");
    ...
    static_assert(!detail::any_of_t<is_invalid_holder, options...>::value,
            "Invalid class_ holder<...> option: given holder type is invalid");
    ...
    static_assert(!detail::any_of_t<is_invalid_alias, options...>::value,
            "Invalid class_ alias<...> option: given alias type is invalid");
    ...
    template <typename T> using is_valid_class_option =
        ...
        >;
    // Make sure all arguments are valid (including, redundantly, any tagged once we checked above),
    // but more importantly, any untagged ones.
