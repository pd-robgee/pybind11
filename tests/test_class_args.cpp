...
typedef py::class_<BreaksBase<10>, py::init_alias<BreaksTramp<10>>> DoesntBreak10;
typedef py::class_<BreaksDerived<11>, BreaksBase<11>> DoesntBreak11;
typedef py::class_<BreaksDerived<12>, py::base<BreaksBase<12>>> DoesntBreak12;
#define CHECK_BASE(N) static_assert(std::is_same<typename DoesntBreak##N::type, BreaksBase<N>>::value, \
        "DoesntBreak" #N " has wrong type!")
CHECK_BASE(1); CHECK_BASE(2); CHECK_BASE(3); CHECK_BASE(4); CHECK_BASE(5); CHECK_BASE(6); CHECK_BASE(7); CHECK_BASE(8);
CHECK_BASE(9); CHECK_BASE(10);
#define CHECK_DERIVED(N) static_assert(std::is_same<typename DoesntBreak##N::type, BreaksDerived<N>>::value, \
        "DoesntBreak" #N " has wrong type!")
CHECK_DERIVED(11); CHECK_DERIVED(12);
#define CHECK_ALIAS(N) static_assert(DoesntBreak##N::has_alias && std::is_same<typename DoesntBreak##N::type_alias, BreaksTramp<N>>::value, \
        "DoesntBreak" #N " has wrong type_alias!")
#define CHECK_NOALIAS(N) static_assert(!DoesntBreak##N::has_alias && std::is_void<typename DoesntBreak##N::type_alias>::value, \
        "DoesntBreak" #N " has type alias, but shouldn't!")
CHECK_ALIAS(1); CHECK_ALIAS(2); CHECK_NOALIAS(3); CHECK_ALIAS(4); CHECK_NOALIAS(5); CHECK_ALIAS(6); CHECK_ALIAS(7); CHECK_NOALIAS(8);
CHECK_ALIAS(9); CHECK_ALIAS(10);
static_assert(DoesntBreak10::init_alias, "DoesntBreak10 should have an always-init alias, but doesn't");
