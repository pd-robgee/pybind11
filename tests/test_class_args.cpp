...
#define CHECK_BASE(N) static_assert(std::is_same<DoesntBreak##N::base_type, BreaksBase<N>>::value, \
        "DoesntBreak" #N " has wrong type!")
CHECK_BASE(1); CHECK_BASE(2); CHECK_BASE(3); CHECK_BASE(4); CHECK_BASE(5); CHECK_BASE(6); CHECK_BASE(7); CHECK_BASE(8);
#define CHECK_ALIAS(N) static_assert(!std::is_same<DoesntBreak##N::base_type, DoesntBreak##N::type>::value && std::is_same<DoesntBreak##N::type, BreaksTramp<N>>::value, \
        "DoesntBreak" #N " has wrong type_alias!")
#define CHECK_NOALIAS(N) static_assert(std::is_same<DoesntBreak##N::base_type, DoesntBreak##N::type>::value, \
        "DoesntBreak" #N " has type alias, but shouldn't!")
CHECK_ALIAS(1); CHECK_ALIAS(2); CHECK_NOALIAS(3); CHECK_ALIAS(4); CHECK_NOALIAS(5); CHECK_ALIAS(6); CHECK_ALIAS(7); CHECK_NOALIAS(8);
#define CHECK_HOLDER(N, TYPE) static_assert(std::is_same<DoesntBreak##N::holder_type, std::TYPE##_ptr<BreaksBase<N>>>::value, \
        "DoesntBreak" #N " has wrong holder_type!")
CHECK_HOLDER(1, unique); CHECK_HOLDER(2, unique); CHECK_HOLDER(3, unique); CHECK_HOLDER(5, unique);
CHECK_HOLDER(6, shared); CHECK_HOLDER(7, shared); CHECK_HOLDER(8, shared);
static_assert(std::is_same<DoesntBreak4::holder_type, std::unique_ptr<BreaksTramp<4>>>::value, "DoesntBreak4 has wrong holder_type!");
...
#define CHECK_BROKEN(N) static_assert(std::is_same<Breaks##N::type, BreaksBase<-N>>::value, \
